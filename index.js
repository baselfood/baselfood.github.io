...
class blog {
    constructor(name, text, imgs, ratings, infoBox, openingTimes, urlName, postDate, writer, shortDescription, coverImg, pos) {
        this.name = name;
        ...
        if (this.pos) {
            ...
            window.initMap = function() {
                ...
                map = new google.maps.Map(map, {
                    center: {lat: 47.5451464, lng: 7.5869987},
                    zoom: 12,
                });
    ...
    const pastBlogs = [ // Make blog class and make coverImg optional
        ...
        {
            name: "Februar Special: Tibits",
            urlName: "Tibits",
            postDate: new Date("2/24/2022"),
            coverImg: "unreachable",
            shortDescription: "Ein kleiner Dialog über das coole, vegetarische Restaurant am Bahnhof mit einem Specialguest."
        }
    ]
